...
from studio.api.nwb.studio_data import PostProcess
from studio.api.nwb.nwb import NWBDATASET
...
class NWBCreater:
    ...
    def behavior(cls, nwbfile, key, value):
        ...
        nwbfile.processing['studio'].add(timeseries_data)
    ...
    def postprocess(cls, nwbfile, key, value):
        ...
        nwbfile.processing['studio'].add_container(postprocess)
