...
* [2. Make frontend environment](#2-make-frontend-environment)
   ...
   * [For Linux Users](#for-linux-users)
      ...
      * [docker-compose up frontend](#docker-compose-up-frontend-1)
      * [Launch browser.  <a href="http://localhost:3000" rel="nofollow">http://localhost:3000</a>](#launch-browser--httplocalhost3000-2)
...
* [3. Make backend environment](#3-make-backend-environment)
   ...
   * [For Windows(WSL2) or Linux Users](#for-windowswsl2-or-linux-users)
   ...
   * [For Mac Users](#for-mac-users-1)
      * [Install Anaconda](#install-anaconda-2)
      * [Create anaconda environment](#create-anaconda-environment-2)
      * [Install mamba](#install-mamba-2)
      * [Install library](#install-library-2)
      * [Install CaImAn](#install-caiman)
      * [run backend](#run-backend-2)
      * [Reload your browser. If you can select the "Algorithm" tab, it is working correctly!](#reload-your-browser-if-you-can-select-the-algorithm-tab-it-is-working-correctly-2)
      * [FAQ](#faq)
