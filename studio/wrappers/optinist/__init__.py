from studio.wrappers.optinist.basic_neural_analysis import (
    basic_neural_analysis_wrapper_dict,
)
from studio.wrappers.optinist.dimension_reduction import (
    dimension_reduction_wrapper_dict,
)
from studio.wrappers.optinist.neural_decoding import neural_decoding_wrapper_dict
from studio.wrappers.optinist.neural_population_analysis import (
