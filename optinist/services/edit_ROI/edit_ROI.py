...
from optinist.services.nwb.nwb_creater import overwrite_nwb
...
from optinist.services.rules.runner import Runner
from optinist.services.utils.filepath_creater import join_filepath
from optinist.services.utils.filepath_finder import find_condaenv_filepath
...
class EditROI:
    ...
    def get_algo(self):
        from optinist.services.edit_ROI import edit_roi_wrapper_dict
