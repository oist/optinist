...
from studio.api.snakemake.smk import SmkParam, ForceRun
from studio.api.snakemake.snakemake_executor import delete_dependencies, snakemake_execute
from studio.api.workflow.workflow import Edge, Node, NodeData
...
output_dirpath = "/tmp/studio/output/snakemake"
...
def test_error_snakemake_execute():
    ...
    error_log_filepath = "/tmp/studio/output/snakemake/error.log"
