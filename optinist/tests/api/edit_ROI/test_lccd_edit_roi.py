...
shutil.rmtree(f"{DIRPATH.OUTPUT_DIR}/lccd", ignore_errors=True)
shutil.copytree(
    f"{DIRPATH.OPTINIST_DIR}/output_test/lccd",
    f"{DIRPATH.OUTPUT_DIR}/lccd",
    dirs_exist_ok=True,
)
file_path = f"{DIRPATH.OUTPUT_DIR}/lccd/lccd_cell_detection/cell_roi.json"
